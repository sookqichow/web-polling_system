...
if (isset($_GET['candidate_id'])) {
    ...
    $sqlcandidate = "SELECT * FROM tbl_candidates WHERE candidate_id = '$candidate_id'";
...
<body>
    ...
    <div class="w3-theme-2">
        ...
        <div class="w3-bar w3-theme-2">
            <a href="candidateList.php" class="w3-bar-item w3-button w3-right">Back</a>
        </div>
    </div>
    <div >
        <?php
        ...
        echo " <div><p>Manifesto: <br>$candidate_manifesto</p>
        </div>";
           
        ?>
        <!-- <form action='candidatedetails.php' method='post'> 
                    <input type='hidden'  name='candidate_id' value='$candidate_id'>
                    <input class='w3-button w3-theme w3-round' type='submit' name='vote' value='Subscribe'>
                    <input type='radio' id='radioleft' name='align' value='vote' />
            <label class='e-btn' for='radioleft'>vote</label>
                </form><br>
                </div> -->
    </div>
    <br>
