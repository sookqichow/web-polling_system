...
if (isset($_GET['submit'])) {
    ...
    if ($operation == 'search') {
        $search = $_GET['search'];
            $sqlcandidate = "SELECT * FROM tbl_sbmcandidates WHERE candidate_name LIKE '%$search%'";

    }
} else {
    $sqlcandidate = "SELECT * FROM tbl_sbmcandidates";
}
...
<body>
    ...
    <div class="w3-card w3-container w3-padding w3-margin w3-round w3-theme-2">
        <h2>School of Business Management</h2>
        </div>
