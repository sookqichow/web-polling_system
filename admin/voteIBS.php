...
<body>
    <div class="topnav">
        ...
        <a href="index.php" class="w3-bar-item w3-button w3-left">Homepage</a>
            ...
            <a href="voteSBM.php" class="w3-hide-small ">Vote</a>
    ...
    <div class="w3-card w3-container w3-padding w3-margin w3-round">
        <h3>School of Islamic Business School</h3>
    ...
    <div class="w3-grid-template">
        ...
        <img class="photo " src="images/candidate03.jpeg" style='height:250px ;width:250px'>
        ...
        <button class=' w3-theme-2 w3-round w3-block'  id='viewbutton' type="submit" name="submit" value="vote"><a href='end.php'>Vote</a></button>
        </div>
        </div>
        <div class="slideshow-container">
        <div style='padding:10px'>
        <img class="photo " src="images/candidate04.jpeg" style='height:250px ;width:250px'>
        ...
        <button class=' w3-theme-2 w3-round w3-block' id='viewbutton' type="submit" name="submit" value="vote"><a href='voteIBS.php'>Vote</a></button>
        </div>
        </div>
        <div class="slideshow-container">
        <div style='padding:10px'>
        <img class="photo " src="images/candidate05.jpeg" style='height:250px ;width:250px'>
    ...
    <div class="w3-center w3-bottom w3-theme" style="max-width:1500px;margin:0 auto;">Web Polling System</div>
</body>
</html>